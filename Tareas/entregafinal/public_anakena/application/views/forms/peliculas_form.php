...
<div id="contact">
<center>	<h3>Buscar pelicula</h3></center>
	<form action="<?=$this->config->base_url();?>index.php/index/searchPeliculas" method="post">
		<fieldset>
			<label for="name">Titulo:</label>
			<input type="text" id="name" name="titulo" placeholder="Introduce el titulo de la pelicula" />
	...
	<a href="<?=$this->config->base_url();?>index.php/index/specialSearchPeliculas">  <input type="button" id="btnModalSubmit" class="btn btn-primary" value="Malos directores" align="left"></a>
</div></td></tr>
</div>