...
<div id="contact">
<center>	<h3>Buscar personas</h3></center>
	<form action="<?=$this->config->base_url();?>index.php/index/searchSocial" method="post">
		<fieldset>
	...
	<a href="<?=$this->config->base_url();?>index.php/index/specialSearchSocial">  <input type="button" id="btnModalSubmit" class="btn btn-primary" value="Personas populares y sus servicios" align="left"></a>
</div></td></tr>
</div>